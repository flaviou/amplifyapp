      ...
      >
        ...
        >
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7wlw")}
          >
            <Text
              fontFamily="Inter"
              fontSize="24px"
          ...
          <Divider
            ...
            {...getOverrideProps(overrides, "Dividerrmb")}
          ></Divider>
          <Flex
            gap="8px"
            direction="column"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7djx")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <Divider
            ...
            size="small"
            orientation="horizontal"
            {...getOverrideProps(overrides, "Dividerahz")}
          ></Divider>
          <Flex
            gap="8px"
            direction="column"
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 7xfc")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
      ...
      >
        ...
        >
          ...
          <Flex
            ...
            alignItems="flex-start"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 28cuz")}
          >
            <Button
              borderRadius="4px"
              display="flex"
              ...
              variation="primary"
              children="XXS"
              {...getOverrideProps(overrides, "Buttongqe")}
            ></Button>
            <Button
              border="1px SOLID rgba(0,0,0,0)"
              borderRadius="4px"
              ...
              variation="primary"
              children="XS"
              {...getOverrideProps(overrides, "Buttonnxa")}
            ></Button>
            <Button
              border="1px SOLID rgba(0,0,0,0)"
              borderRadius="4px"
              ...
              variation="primary"
              children="S"
              {...getOverrideProps(overrides, "Buttonarm")}
            ></Button>
            <Button
              border="1px SOLID rgba(0,0,0,0)"
              borderRadius="4px"
              ...
              variation="primary"
              children="M"
              {...getOverrideProps(overrides, "Buttonmjg")}
            ></Button>
          </Flex>
          <Flex
            gap="24px"
            ...
            alignItems="flex-start"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Frame 28lsg")}
          >
            <Button
              gap="24px"
              border="1px SOLID rgba(0,0,0,0)"
            ...
            <Button
              ...
              variation="primary"
              children="XL"
              {...getOverrideProps(overrides, "Buttonoln")}
            ></Button>
            <Button
              gap="24px"
              border="1px SOLID rgba(0,0,0,0)"
              ...
              variation="primary"
              children="2XL"
              {...getOverrideProps(overrides, "Buttonziq")}
            ></Button>
            <Button
              gap="24px"
              border="1px SOLID rgba(0,0,0,0)"
              ...
              variation="primary"
              children="3XL"
              {...getOverrideProps(overrides, "Buttonbvb")}
            ></Button>
          </Flex>
          <Text
            fontFamily="Inter"
