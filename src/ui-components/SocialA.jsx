  ...
  return (
    ...
    >
        ...
        >
          ...
          >
            <MyIcon
              shrink="0"
              type="arrow-right"
              {...getOverrideProps(overrides, "MyIconfaz")}
            ></MyIcon>
            <Text
              fontFamily="Inter"
              fontSize="16px"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Shareere")}
          >
            <Text
              fontFamily="Inter"
              fontSize="16px"
              ...
              whiteSpace="pre-wrap"
              children="Share"
              {...getOverrideProps(overrides, "Sharelqq")}
            ></Text>
            <MyIcon
              shrink="0"
              type="bookmark_border"
              {...getOverrideProps(overrides, "MyIconeme")}
            ></MyIcon>
            <MyIcon
              shrink="0"
              type="share"
              {...getOverrideProps(overrides, "MyIconjgx")}
            ></MyIcon>
            <MyIcon
              shrink="0"
              type="more_vert"
              {...getOverrideProps(overrides, "MyIconocy")}
            ></MyIcon>
          </Flex>
        </Flex>
        <Image
      ...
      <Flex
        ...
        position="relative"
        padding="0px 0px 0px 0px"
        {...getOverrideProps(overrides, "Read morexrf")}
      >
        <MyIcon
          shrink="0"
          type="arrow-right"
          {...getOverrideProps(overrides, "MyIconujv")}
        ></MyIcon>
        <Text
          fontFamily="Inter"
          fontSize="16px"
          ...
          whiteSpace="pre-wrap"
          children="Read more"
          {...getOverrideProps(overrides, "Read morekgc")}
        ></Text>
      </Flex>
    </Flex>
  );
