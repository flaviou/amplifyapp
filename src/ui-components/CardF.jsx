      ...
      >
        ...
        >
          <Badge
            ...
            variation="default"
            children="New"
            {...getOverrideProps(overrides, "Badgefvy")}
          ></Badge>
          <Badge
            fontSize="12px"
            lineHeight="12px"
            ...
            variation="default"
            children="Classic"
            {...getOverrideProps(overrides, "Badgemly")}
          ></Badge>
          <Badge
            fontSize="12px"
            lineHeight="12px"
            ...
            variation="default"
            children="Modern"
            {...getOverrideProps(overrides, "Badgeqrb")}
          ></Badge>
        </Flex>
        <Text
          fontFamily="Inter"
        ...
        >
          ...
          >
            <View
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Iconuus")}
            >
              <Icon
                width="17.58984375px"
                ...
                left="14.21%"
                right="12.5%"
                {...getOverrideProps(overrides, "Vectorjbw")}
              ></Icon>
            </View>
            <Text
              fontFamily="Inter"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Featurefrh")}
          >
            <View
              width="24px"
              height="24px"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Iconxzo")}
            >
              <Icon
                width="17.58984375px"
                height="13.40997314453125px"
                ...
                left="14.21%"
                right="12.5%"
                {...getOverrideProps(overrides, "Vectorihr")}
              ></Icon>
            </View>
            <Text
              fontFamily="Inter"
          ...
          <Flex
            ...
            position="relative"
            padding="0px 0px 0px 0px"
            {...getOverrideProps(overrides, "Featurerzv")}
          >
            <View
              width="24px"
              height="24px"
              ...
              position="relative"
              padding="0px 0px 0px 0px"
              {...getOverrideProps(overrides, "Iconfrk")}
            >
              <Icon
                width="17.58984375px"
                height="13.40997314453125px"
